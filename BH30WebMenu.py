...
@route("/80L")
@route("/80L/<name>")
def relayOne(self=None, name="80L"):
    sleep(.5)
...
@route("/80H")
@route("/80H/<name>")
def relayTwo(self=None, name="80H"):
    sleep(.5)
...
@route("/40L")
@route("/40L/<name>")
def relayThree(self=None, name="40L"):
    sleep(.5)
...
@route("/40H")
@route("/40H/<name>")
def relayFour(self=None, name="40H"):
    sleep(.5)
...
@route("/20L")
@route("/20L/<name>")
def relayFive(self=None, name="20L"):
    sleep(.5)
...
@route("/20H")
@route("/20H/<name>")
def relaySix(self=None, name="20H"):
    sleep(.5)
...
@route("/15")
@route("/15/<name>")
def relaySeven(self=None, name="15"):
    sleep(.5)
...
@route("/10")
@route("/10/<name>")
def relayEight(self=None, name="10"):
    sleep(.5)
